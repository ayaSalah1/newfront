...
function EmployeesEmployeesTap() {
    ...
    return (
        <>
            <div className={"w-full mt-10 flex flex-wrap h-full items-center"}>
                ...
                <div className={"w-full flex flex-wrap h-full gap-10"}>
                  <TreeComponent title={"الأقسام"} />
                    <div className={"w-fit"}>
                        <TableWithBtns  title={"جدول الموظفين"} isInput={true} inputTitle={"بحث"} inputName={"search"} inputValue={""} inputClass={"my-5"}>
                            <thead
            ...
            <EditEmployeeModal isModalOpen={isEditEmployeeModalOpen} onClose={displayEditEmployeeModal}/>
        </>
